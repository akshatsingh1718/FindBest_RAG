...
from chain.chains import StageAnalyzerChain, ConversationChain, LLMChain
from utils.constant import Constant as C
from utils.tools import setup_knowledge_base, get_tools
from prompt.templates import CustomPromptTemplateForTools
...
from prompt.prompts import SALES_AGENT_TOOLS_PROMPT, STAGE_ANALYZER_INCEPTION_PROMPT, CONVERSATION_AGENT_INCEPTION_PROMPT
from prompt.variables import (
...
from conversation.stages import CONVERSATION_STAGES, END_CONVERSATION_STAGE_ID, START_CONVERSATION_STAGE_ID
...
class SalesGPT(Chain):
    ...
    current_conversation_stage: str = CONVERSATION_STAGES.get(START_CONVERSATION_STAGE_ID)
    ...
    def seed_agent(self) -> None:
        ...
        self.current_conversation_stage = self.retrieve_conversation_stage(START_CONVERSATION_STAGE_ID)
    ...
    def from_llm(
        self,
        llm: Union[ChatOpenAI, ChatLiteLLM],
        verbose: bool = True,
        use_tools: bool = False,
        **kwargs,
    ) -> "SalesGPT":
        ...
        if use_tools:
            product_catalog= kwargs[C.PRODUCT_CATALOGUE_KWARG] 
            # tools_prompt= kwargs[C.TOOLS_PROMPT_KWARG]
